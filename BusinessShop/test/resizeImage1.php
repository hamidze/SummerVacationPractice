...
$outFun($dst_50_image,"image_50/".$filename);
$outFun($dst_220_image,"image_220/".$filename);
$outFun($dst_350_image,"image_350/".$filename);
$outFun($dst_800_image,"image_800/".$filename);
